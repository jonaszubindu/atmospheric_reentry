...
class Logging:
        ...
        return pd.DataFrame(
            {
                ...
                "velocity geodetic lat": self.velocity_geodetic[:n, 0],
                "velocity geodetic lon": self.velocity_geodetic[:n, 1],
    ...
    def get_last_log_entry(self) -> dict | None:
        ...
        return {
            ...
            "velocity geodetic lat": self.velocity_geodetic[i, 0],
            "velocity geodetic lon": self.velocity_geodetic[i, 1],
